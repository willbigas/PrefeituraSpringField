 ...
 */
package br.com.prefeitura.negocio;
...
import static br.com.prefeitura.principal.Principal.COMERCIALS;
import static br.com.prefeitura.principal.Principal.IMOVELS;
import static br.com.prefeitura.principal.Principal.RESIDENCIALS;
import static br.com.prefeitura.principal.Principal.VAZIOS;
        ...
        for (int i = 0; i < IMOVELS.size(); i++) {
            ...
            if (IMOVELS.get(i) instanceof Comercio) {
                ...
                System.out.println(aux.getProprietario() + " - " + aux.getEndereco() + " - "
                        + br.com.prefeitura.util.UtilFormat.decFormatR$(aux.calculaIptu()) + " - " + br.com.prefeitura.util.UtilFormat.decFormatR$(valorImovel) + " - "
                        + br.com.prefeitura.util.UtilFormat.decFormatR$(valorEdificacao) + " - " + br.com.prefeitura.util.UtilFormat.decFormatR$(somaImpostos) + " - "
                        + br.com.prefeitura.util.UtilFormat.decFormatR$(valorTotal));
            }
